...
#include <GameHeaders/Projectile.hpp>
...
void World::loadTextures()
{
	...
	mTextures.load(Textures::Avenger, "content/Avenger.png");
	mTextures.load(Textures::Desert, "content/Desert.png");

	mTextures.load(Textures::Bullet, "content/Bullet.png");
	mTextures.load(Textures::Missile, "content/Missile.png");

	mTextures.load(Textures::HealthRefill, "content/HealthRefill.png");
	mTextures.load(Textures::MissileRefill, "content/MissileRefill.png");
	mTextures.load(Textures::FireSpread, "content/FireSpread.png");
	mTextures.load(Textures::FireRate, "content/FireRate.png");
}
